...
urlpatterns = [
   ...
   #para recuperação de senha
    ...
    path('password-reset/confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name="recuperar_senha/nova_senha.html"), name="password_reset_confirm"),
